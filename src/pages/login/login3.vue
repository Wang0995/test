<template>
  <div v-bind:class="[{ signUpMode: isUp }, container]">
...
<style lang="scss">
  ...
  * {
  ...
  .container:before {
    ...
    background-image: linear-gradient(-45deg, #f13a2f 0%, #cb2d2d 100%);
  ...
  .container.signUpMode form.sign-up-form {
    opacity: 1;
    z-index: 2;
  }

  .container.signUpMode form.sign-in-form {
    opacity: 0;
    z-index: 1;
  }
